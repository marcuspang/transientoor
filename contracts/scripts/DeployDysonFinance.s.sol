...
import "dyson_finance/src/Agency.sol";
import "dyson_finance/src/DYSON.sol";
import "dyson_finance/src/sDYSON.sol";
import "dyson_finance/src/Factory.sol";
import "dyson_finance/src/Pair.sol";
import "dyson_finance/src/Router.sol";
import "dyson_finance/src/Farm.sol";
import "dyson_finance/src/Gauge.sol";
import "dyson_finance/src/Bribe.sol";
import "dyson_finance/src/util/AddressBook.sol";
import "dyson_finance/src/util/TokenSender.sol";
import "interface/IERC20.sol";
import "dyson_finance/src/util/Addresses.sol";
...
contract MainnetDeployScript is Addresses, Test {
    ...
    function run() external {
        ...
        // Create pairs
        transient_pair = Pair(factory.createPair(0x5a38BB9D84fEBf451c18282767BB11119B1CAD19, 0xfcD57f579733a96C97608D6c7FF3a93151f4Cf0E));
        console.log("%s: %s", "dysn_usdc_pair",address(transient_pair));
        ...
        address dysonGauge = address(new Gauge(address(farm), address(sDyson), address(transient_pair), WEIGHT_DYSN, BASE, SLOPE));
        ...
        addressBook.setCanonicalIdOfPair(address(0x5a38BB9D84fEBf451c18282767BB11119B1CAD19), address(0xfcD57f579733a96C97608D6c7FF3a93151f4Cf0E), 1);
